# Auteur: Anas Khchaf, Camille Vauchel
# Cadre: Projet de Cryptographie - Master 1 Informatique - Institut Galilee, Universite Paris 13
# Objet: Developpement de l'algorithme de Cryptage AES Version 128 bits
# Creation: 11/04/2014
# Execution : 	Ligne de Commande (ei) : "python Nom_de_ce_fichier Texte_Brut Clef_Privee" 
# 				Entree : -Texte_Brut : Text Brut a chiffrer
#						 -Clef_Privee : Clef Privee de 16 Caracteres (l'equivalant de 128 bits) 
...
def main(argv):
	if (len(argv)!=2):
		print "Erreur le nombre d'argument n'est pas correct"
		return 0
